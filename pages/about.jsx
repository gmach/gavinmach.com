const AboutPage = () => {
  ...
  for (let i = 0; i < numStars; i++) {
    // return <Star pos={getRandomPosition}/>
  }
...
<div id="board">  
  <div id="content">
    ...
    <br/>
    <p>
    Hi there! I'm Gavin a passionate full stack developer from Sydney Australia.
    I Have a long history with software development having worked in both the backend server side to the frontend client and now as a full stack developer.
    I've developed in various languages from Java to Javascript and can pickup any new technologies pretty quickly.
</p>
<p>More recently I have also developed with Web3 technologies including developing Smart Contracts using Solidity for the Ethereum blockchain.
</p>

<h2 className="subheading">My Education</h2>
<p>
I completed my degree in Bachelor of Technology in Computer Science from University of Technology Sydney. Although 
my degree only taught C and C++ which I rarely use, I did learn the fundamentals in programming
for any language including data types and structures, control flow, functional vs object oriented programming, database design, 
user interface and basic web design. 
</p>
<p>To be frank I self taught myself most of the modern languages that I still use today which I've used throughout my career and personal projects. 
I love exploring new technologies and like to stay on top of the latest trends like Web3 in particular.
</p>

<h2 className="subheading">My Programming Style</h2>
<p>
I prefer to use primitives wherever possible like pure ES6 Javascript, React, and clean semantic CSS and HTML for most functionality
rather than reaching for libraries which adds alot of bloat and opinionated design. 
This also helps to becoming more proficient in the language semantics but I admit it can add more code than necessary however 
the code is easier to understand compared to spaghetti code from a multitude of competing technologies. 
</p>
  </div>  
</div>
